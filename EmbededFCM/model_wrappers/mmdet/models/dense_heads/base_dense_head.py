...
from model_wrappers.mmdet.core.utils import filter_scores_and_topk, select_single_mlvl
...
class BaseDenseHead(BaseModule, metaclass=ABCMeta):
    ...
    def onnx_export(self,
        ...
        for cls_score, bbox_pred, score_factors, priors in zip(
            ...
            from model_wrappers.mmdet.core.export import get_k_for_topk
        ...
        from model_wrappers.mmdet.core.export import add_dummy_nms_for_onnx
